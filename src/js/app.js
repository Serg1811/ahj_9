...
btnCollapse.addEventListener('click', () => {
  const collapseContainer = animationContainer.querySelector('.collapse-container');
...
btnCallbackChat.addEventListener('click', () => {
  const callbackChatContainer = animationContainer.querySelector('.callback-chat-container');
  if (callbackChatContainer) {
    callbackChatContainer.remove();
  } else {
    clearPlace(animationContainer);
...
btnLiker.addEventListener('click', () => {
  const likerContainer = animationContainer.querySelector('.liker-container');
  if (likerContainer) {
    likerContainer.remove();
  } else {
    clearPlace(animationContainer);
